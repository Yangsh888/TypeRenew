...
<form action="<?php $security->index('/action/reset'); ?>" method="post" name="reset" role="form" class="tr-auth-form">
    <div class="tr-auth-field">
        ...
        <input type="password" id="password" name="password" placeholder="<?php _e('至少 %d 个字符，不超过 %d 字节', \Utils\Password::minLength(), \Utils\Password::maxLength()); ?>" required autofocus />
    </div>
    <div class="tr-auth-field">
