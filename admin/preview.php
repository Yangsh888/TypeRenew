...
<script>
    (function () {
        ...
        function ensureCloseButton() {
            ...
            button.textContent = <?php echo \Typecho\Common::jsonEncode(_t('关闭预览'), JSON_UNESCAPED_UNICODE | JSON_HEX_TAG | JSON_HEX_AMP | JSON_HEX_APOS | JSON_HEX_QUOT, '""'); ?>;
            button.setAttribute('aria-label', <?php echo \Typecho\Common::jsonEncode(_t('关闭预览'), JSON_UNESCAPED_UNICODE | JSON_HEX_TAG | JSON_HEX_AMP | JSON_HEX_APOS | JSON_HEX_QUOT, '""'); ?>);
