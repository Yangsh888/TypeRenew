...
<header class="typecho-head-nav tr-topbar" role="navigation" aria-label="<?php _e('顶部栏'); ?>">
    ...
    <div class="tr-topbar-right">
        ...
        <div class="tr-topbar-tools" aria-label="<?php _e('快捷工具'); ?>">
            ...
            <button type="button" class="tr-pill tr-pill-btn tr-pill-kbd" id="trCmdBtn" title="<?php _e('快捷命令'); ?>" aria-haspopup="dialog" aria-controls="trCmdDialog" aria-expanded="false">
