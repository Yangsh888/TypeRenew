...
class Menu extends Base
{
    ...
    public function execute()
    {
        ...
        $childNodes = [
            ...
            [
                ...
                [_t('升级'), _t('升级程序'), 'upgrade.php', 'administrator'],
            ...
            [
                ...
                [_t('缓存'), _t('缓存设置'), 'options-cache.php', 'administrator'],
                [_t('邮件'), _t('邮件通知'), 'options-mail.php', 'administrator'],
            ],
            [
    ...
    public function getCurrentParentLabel(): ?string
    {
