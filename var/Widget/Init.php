...
class Init extends Widget
{
    public function execute()
    {
        ...
        define('__TYPECHO_CLASS_ALIASES__', [
            ...
            'Typecho_Plugin_Exception'              => '\Typecho\Plugin\Exception',
