...
TypeRenew 基于开源博客系统 Typecho，并在完整兼容的前提下进行二次开发与焕新。项目全面继承其轻量、简洁、高效的内核基因，同时针对现代运行环境进行优化，修复兼容问题并原生集成多项实用功能，以及安全中心、SEO、优化加速、外链控制与 Vditor 编辑器等官方拓展插件，适合个人博客或轻量内容站点的搭建，QQ 交流群：1073739854
...
- 内置多语言支持，仓库内提供 `usr/langs/typerenew.pot` 提取模板，放入 `.mo` 语言包后可在基本设置中切换语言
